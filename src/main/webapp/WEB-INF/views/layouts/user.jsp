...
<!-- Customize styles -->
<link href="<c:url value="/assets/user/tyle.css"/>" rel="stylesheet" />
<!-- font awesome styles -->
<link href="<c:url value="/assets/user/font-awesome/css/font-awesome.css" />" rel="stylesheet">

<!-- Favicons -->
<link rel="shortcut icon" href="<c:url value="/assets/user/assets/ico/favicon.ico"/>">
</head>
<body>
	<!-- 
			...
			<div class="container">
				<div class="alignR">
					...
					<a href="index.html"> <span class="icon-home"></span> Home
						...
						Contact us</a> <a class="active" href="cart.html"><span
							...
							<tr>
								<td>
									<form class="form-horizontal">
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" class="shopBtn">Click to
													check the price</button>
											</div>
										</div>
									</form>
								</td>
